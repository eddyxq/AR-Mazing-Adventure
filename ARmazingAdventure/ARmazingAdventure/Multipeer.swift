...
//  ARmazingAdventure
//
//  Created by Hanum Lee on 2019-11-19.
...
class Multipeer: NSObject {
    ...
    init(receivedDataHandler: @escaping (Data, MCPeerID) -> Void ) {
        ...
        serviceAdvertiser = MCNearbyServiceAdvertiser(peer: myPeerID, discoveryInfo: nil, serviceType: Multipeer.serviceType)
        serviceAdvertiser.delegate = self
        serviceAdvertiser.startAdvertisingPeer()
        
        serviceBrowser = MCNearbyServiceBrowser(peer: myPeerID, serviceType: Multipeer.serviceType)
